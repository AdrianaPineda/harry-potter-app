...
class MockHarryPotterApiClientInterface: HarryPotterApiClientInterface, Cuckoo.ProtocolMock {
    ...
    required init(baseUrl _: String, apiKey _: String) {}
    ...
    struct __StubbingProxy_HarryPotterApiClientInterface: Cuckoo.StubbingProxy {
        ...
        func getCharacters() -> Cuckoo.ProtocolStubFunction<Void, Promise<[Character]>> {
            let matchers: [Cuckoo.ParameterMatcher<Void>] = []
            return .init(stub: cuckoo_manager.createStub(for: MockHarryPotterApiClientInterface.self,
                                                         method: "getCharacters() -> Promise<[Character]>",
    ...
    struct __VerificationProxy_HarryPotterApiClientInterface: Cuckoo.VerificationProxy {
        ...
        @discardableResult
        func getCharacters() -> Cuckoo.__DoNotUse<Void, Promise<[Character]>> {
            let matchers: [Cuckoo.ParameterMatcher<Void>] = []
